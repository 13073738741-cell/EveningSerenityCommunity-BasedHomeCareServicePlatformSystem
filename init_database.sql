...
-- 使用说明：
-- 1. 确保MySQL已安装并运行
-- 2. 使用root用户执行此脚本：mysql -u root -p < init_database.sql
-- 3. 或者登录MySQL后执行：source /path/to/init_database.sql

-- 创建数据库
CREATE DATABASE IF NOT EXISTS elderlycare DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
SELECT COUNT(*) AS elderly_count FROM elderly_info;
